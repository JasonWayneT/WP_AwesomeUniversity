...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>Awesome</strong> University</a></h1>
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          <span class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true" id='mainSearchBtn'></i></span>
        </div>
      </div>
    </div>
  </header>
